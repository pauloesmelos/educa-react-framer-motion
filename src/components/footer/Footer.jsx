...
const Footer = () => {
  return (
    <footer className="w-full p-8 bg-teal mt-32">
        <div className="w-full max-w-[1300px] mx-auto text-white grid grid-cols-4">
          {/* get started */}
          <div className="w-full">
            <h3 className="font-bold text-3xl mb-5">Get Started</h3>
          ...
          {/* services */}
          <div className="ml-12">
            <h3 className="font-bold text-3xl mb-5">Services</h3>
          ...
          {/* company */}
          <div>
            <h3 className="font-bold text-3xl mb-5">Company</h3>
            <ul className="flex flex-col gap-4 text-lg">
          ...
          {/* follow us */}
          <div>
            <h3 className="font-bold text-3xl mb-5">Follow Us</h3>
            <ul className="flex flex-col gap-4 text-lg">
